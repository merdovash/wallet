...
- Счета, чек-ины (с переводами), графики прироста (переводы не считаются ростом)
- Кредитки с настраиваемым грейсом (траты месяца N → конец N+срок): остаток лимита в чек-ине, вкладка Float по месяцам
- Сводка по валютам на обзоре
...
- PWA: сайт можно установить как приложение («Установить приложение» в Chrome / «На экран „Домой“» в Safari); статика кэшируется service worker'ом, обновления подхватываются автоматически. Для установки нужен HTTPS (или localhost)
...
Откройте http://localhost:5173 — зарегистрируйтесь / войдите.
